...
function Resultats({resultats, data, dataLastWeek, departement}) {

    let j = data.allLiveFranceData.filter(element => element.code === departement)[0];
    let j7 = dataLastWeek.allFranceDataByDate.filter(element => element.code === departement)[0];
